...
T_temp(2:m,2:n+1)=T(2:m,2:n+1)+delt_heat*((vel_mesh(2:m,2:n+1)).*((T((2:m)+1,2:n+1)-T((2:m)-1,2:n+1))./(y((2:m)+1,2:n+1)-y((2:m)-1,2:n+1)))+((DFlow(2:m,2:n+1)).*((((T((2:m)+1,2:n+1)-T(2:m,2:n+1))./(y((2:m)+1,2:n+1)-y(2:m,2:n+1)))-((T(2:m,2:n+1)-T((2:m)-1,2:n+1))./(y(2:m,2:n+1)-y((2:m)-1,2:n+1))))./(y(2:m,2:n+1)-y((2:m)-1,2:n+1))))-((vel_prof_y(2:m,2:n+1)).*((T((2:m),2:n+1)-T((2:m)-1,2:n+1))./(y((2:m),2:n+1)-y((2:m)-1,2:n+1))))-(((x(2:m,(2:n+1))-x(2:m,(2:n+1)-1))./(((x(2:m,(2:n+1))-x(2:m,(2:n+1))-1).^2+(y(2:m,(2:n+1))-y(2:m,(2:n+1))-1).^2).^.5)).*(vel_prof(2:m,2:n+1)).*((T(2:m,(2:n+1))-T(2:m,(2:n+1)-1))./(x(2:m,(2:n+1))-x(2:m,(2:n+1)-1)))));
